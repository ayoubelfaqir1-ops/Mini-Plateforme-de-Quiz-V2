            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-10 md:flex md:space-x-8">
                    ...
                    <a href="<?= $basePath ?>student/quizzes.php" 
                       class="<?= ($currentPage ?? '') === 'quizzes' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        <i class="fas fa-question-circle mr-2"></i>Quizzes
                    </a>
                    
                    <!-- Mes Résultats -->
                    <a href="<?= $basePath ?>student/results.php" 
                       class="<?= ($currentPage ?? '') === 'results' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
